...
public class ConfigListFragment extends ListFragment {
	...
	public void onAttach(Activity activity) {
		...
		Cursor c = db.query(ConfigEntry.TABLE_NAME, ConfigEntry.getFullProjection(), null, null, null, null, null);
	...
	public void onListItemClick(ListView l, View v, int position, long id) {
		PinpadConfigActivity.setActive(getActivity(), PinpadConfigActivity.get(getActivity(), id));
	...
	public void onPrepareOptionsMenu(Menu menu) {
		menu.findItem(R.id.configs_list_delete).setEnabled(getListAdapter().getCount() > 1);
		super.onPrepareOptionsMenu(menu);
	}

	@Override
	public boolean onOptionsItemSelected(MenuItem item) {
		final Config active = PinpadConfigActivity.getActive(getActivity());
		switch (item.getItemId()) {
		case R.id.configs_list_new: {
			Intent intent = new Intent(getActivity(), ConfigDetailActivity.class);
		...
		case R.id.configs_list_delete: {
			...
			new AlertDialog.Builder(getActivity()).setTitle("Delete configuration")
				.setMessage("Do you want to delete configuration '" + active.getTitle() + "'?")
				.setPositiveButton("OK", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int which) {
						SQLiteDatabase db = new ConfigsDbHelper(getActivity()).getWritableDatabase(); 
						db.delete(ConfigEntry.TABLE_NAME, ConfigEntry._ID + " LIKE ?", new String[] {String.valueOf(active.getId())});
						
						Cursor c = db.query(ConfigEntry.TABLE_NAME, ConfigEntry.getFullProjection(), null, null, null, null, null);
						if (c.moveToFirst()) {
							PinpadConfigActivity.setActive(getActivity(), PinpadConfigActivity.get(getActivity(), c.getLong(c.getColumnIndexOrThrow(ConfigEntry._ID))));
						}
