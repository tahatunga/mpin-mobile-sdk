...
/*** MULTIPLY ***/      /* multiply a by b, result in c */
  ...
  sumhi=extra;
  extra=0;
  lo=_umul128(a[0],b[3],&hi);
  sumlo+=lo;
  hi+=(sumlo<lo);
  sumhi+=hi;
  extra+=(sumhi<hi);
  lo=_umul128(a[1],b[2],&hi);
  sumlo+=lo;
  hi+=(sumlo<lo);
  sumhi+=hi;
  extra+=(sumhi<hi);
  lo=_umul128(a[2],b[1],&hi);
  sumlo+=lo;
  hi+=(sumlo<lo);
  sumhi+=hi;
  extra+=(sumhi<hi);
  lo=_umul128(a[3],b[0],&hi);
  sumlo+=lo;
  hi+=(sumlo<lo);
  sumhi+=hi;
  extra+=(sumhi<hi);
  ...
  sumhi=extra;
  extra=0;
  lo=_umul128(a[1],b[3],&hi);
  sumlo+=lo;
  hi+=(sumlo<lo);
  sumhi+=hi;
  extra+=(sumhi<hi);
  lo=_umul128(a[2],b[2],&hi);
  sumlo+=lo;
  hi+=(sumlo<lo);
  sumhi+=hi;
  extra+=(sumhi<hi);
  lo=_umul128(a[3],b[1],&hi);
  sumlo+=lo;
  hi+=(sumlo<lo);
  sumhi+=hi;
  extra+=(sumhi<hi);
  ...
  sumhi=extra;
  extra=0;
  lo=_umul128(a[2],b[3],&hi);
  sumlo+=lo;
  hi+=(sumlo<lo);
  sumhi+=hi;
  extra+=(sumhi<hi);
  lo=_umul128(a[3],b[2],&hi);
  sumlo+=lo;
  hi+=(sumlo<lo);
  sumhi+=hi;
  extra+=(sumhi<hi);
...
/*** PMULT ***/
  carry=0;
  su=_umul128(a[0],sn,&v);
  su+=carry;
  v+=(su<carry);
  carry=v;
  b[0]=0;
  c[0]=su;
  su=_umul128(a[1],sn,&v);
  su+=carry;
  v+=(su<carry);
  carry=v;
  b[1]=0;
  c[1]=su;
  su=_umul128(a[2],sn,&v);
  su+=carry;
  v+=(su<carry);
  carry=v;
  b[2]=0;
  c[2]=su;
  su=_umul128(a[3],sn,&v);
  su+=carry;
  v+=(su<carry);
  carry=v;
  b[3]=0;
